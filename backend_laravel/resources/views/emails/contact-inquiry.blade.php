...
<body>
    <div class="header">
        <h1 style="margin: 0; color: #007bff;">Новый запрос на сотрудничество</h1>
        <p style="margin: 10px 0 0 0; color: #6c757d;">Получен через форму "ХОТИТЕ СОТРУДНИЧАТЬ?" на сайте NIK Studio</p>
    </div>
    ...
    <div class="footer">
        ...
        <p>Источник: Форма сотрудничества ({{ $source }})</p>
